...
urlpatterns = patterns('',
    ...
    url(r'^about/$', 'mysite.views.comshow', name='about'),         # 首页
...
urlpatterns += patterns('mysite.views',
    ...
    url(r'^account/tip/$', 'comshow', name='comshow'),             # 注册成功
    url(r'^account/verify/(?P<token>\S+)/(?P<uid>\d+)/$', 'verify', name='verify'), # 验证码激活            # 注册成功
    ...
    url(r'^codetheme/feedback/$', 'comshow', name='feedback'),        # 反馈
)
